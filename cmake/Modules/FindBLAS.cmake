# Custom FindBLAS taken from Eigen repository
# https://bitbucket.org/eigen/eigen/src/tip/cmake/
  ...
  foreach(_library ${_list})
    ...
    if(_libraries_found)
      ...
      elseif ( APPLE )
        find_library(${_prefix}_${_library}_LIBRARY
                    NAMES ${_library}
                    PATHS $ENV{ISISROOT}/lib ENV DYLD_LIBRARY_PATH
                    )
      else ()
        find_library(${_prefix}_${_library}_LIBRARY
                    NAMES ${_library}
                    PATHS $ENV{ISISROOT}/lib ENV LD_LIBRARY_PATH
                    )
      endif()
