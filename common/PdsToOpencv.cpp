...
namespace at
{
    ...
    int PDSTileReader::readPDSTileToIplImage( IplImage* &dest, CvRect roi)
    {
        ...
        uchar* data;
        cout<<"PDSTileReader::readPDSTileToIplImage(): test1"<<endl;
	...
	cout<<"PDSTileReader::readPDSTileToIplImage(): test2"<<endl;
	...
	cout<<"PDSTileReader::readPDSTileToIplImage(): test3"<<endl;
	...
	cout<<"PDSTileReader::readPDSTileToIplImage(): test4"<<endl;
	...
	cout<<"PDSTileReader::readPDSTileToIplImage(): test5"<<endl;
