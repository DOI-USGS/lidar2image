...
if not os.environ.has_key('ISIS_ROOT'):
	print >> sys.stderr, 'The environment variable ISIS_ROOT is undefined.'
	sys.exit(1)
ISIS_ROOT = os.environ['ISIS_ROOT']
ISISBIN = ISIS_ROOT + '/bin'
